        ...
        <div class="form-content">
            <div class="row justify-content-center">
                ...
                <section class="col-12 col-md-6 col-lg-4 consumo">
                    ...
                    <input type="number" id="gasInput" placeholder="Digite um número" min="0" step="1" required
                        name="butijoes">
                </section>
                ...
                <section class="col-12 col-md-6 col-lg-4 consumo">
                    ...
                    <input type="number" id="smokeInput" placeholder="Digite um número" min="0" step="1" required
                        name="cigarro">
                </section>
            </div>
