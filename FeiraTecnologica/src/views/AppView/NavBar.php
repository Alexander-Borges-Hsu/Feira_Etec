        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <li class="nav-item">
                <a class="nav-link" href="https://vscode.dev/github/Alexander-Borges-Hsu/Feira_Etec/blob/main/FeiraTecnologica/src/views/Pages/quem_somos.php">Quem somos</a>
              </li>
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li><a class="dropdown-item" href="https://vscode.dev/github/Alexander-Borges-Hsu/Feira_Etec/blob/main/FeiraTecnologica/src/views/Pages/quem_somos.php">Quem Somos</a></li>
                </ul>
              </li>
            </ul>
          </div>
