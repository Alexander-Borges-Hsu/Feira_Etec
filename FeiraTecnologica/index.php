            ...
            <div class="col-md-6 col-sm-12 d-flex align-items-center justify-content-center">
                ...
                <div class="card p-4 shadow-lg text-light w-100" style="max-width: 400px;">
                    ...
                    <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                        ...
                        <!-- Aba de Cadastro -->
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="pills-cadastro-tab" data-bs-toggle="pill"
                        ...
                        <div class="tab-pane fade show active" id="pills-login" role="tabpanel"
                            ...
                            <form method="POST" action="index.php?r=logUser&m=verify&k=PDO">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input id="user" type="text" class="form-control" placeholder="Usuário" required
                                        name="usuario">
                                </div>
                                <!-- Campo de senha -->
                                <div class="mb-3">
                                ...
                                <p id="loginError" class="text-danger" style="display: none;">Usuário ou senha errado!
                                </p>
                        ...
                        <div class="tab-pane fade" id="pills-cadastro" role="tabpanel"
                            ...
                            <form method="POST" action="index.php?r=cadUser&m=create&k=PDO">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input id="newuser" type="text" class="form-control" placeholder="Crie seu Usuário"
                                        required name="newusuario">
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input id="newpass" type="password" class="form-control"
                                        placeholder="Crie sua senha" required name="newsenha">
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input id="confirmpass" type="password" class="form-control"
                                        placeholder="Confirme sua senha" required name="newsenhaC">
                                    <!-- Mensagem de erro para confirmação de senha -->
                                    <p id="errorMessage" class="text-danger" style="display: none;">As senhas devem ser
                                        iguais!</p>
                                </div>
                                <!-- Campo para o e-mail -->
                                <div class="mb-3">
                                    <label for="email" class="form-label">Email</label>
                                    <input id="email" type="email" class="form-control" placeholder="Coloque seu e-mail"
